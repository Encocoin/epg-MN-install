...
COIN_TGZ='https://github.com/Encocoin/encocoinplus/releases/download/3.0.5.1/epgc-3.0.5.1-aarch64-linux-gnu.tar.gz'
...
function important_information() {
 ...
 echo -e "Installed version: ${GREEN}" $(epgcd -version | grep "version v") "${NC}"
...
#purgeOldInstallation	# realy, rm -rf ~/.epgc ?
stop_old_daemom
checks
#prepare_system		# only needed for compilation
download_node
setup_node
